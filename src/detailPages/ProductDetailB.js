...
const ProductDetailB = () => {
  ...
  return (
    <div className="product-detail">
      <h1>Product Feature B</h1>
      <img src="../assets/uploadedImage.png" alt="Product Feature B" className="product-detail-image" />
      <p ref={descriptionRef}>
        Feature B is an advanced solution providing optimized performance and seamless functionality. It is designed to enhance productivity and provide high-value outcomes for diverse applications.
      </p>
